"""
Apply migration 022: Query optimization composite indexes.

Prerequisites:
    - Migrations 020 and 021 must be applied first

Usage:
    python scripts/apply_migration_022_query_optimization.py
"""
...
MIGRATION_FILE = Path(__file__).parent.parent / "backend" / "database" / "migrations" / "022_query_optimization.sql"
...
def main() -> None:
    ...
    logger.info("migration_start", file="022_query_optimization.sql", statements=len(statements))
    ...
    logger.info("migration_complete", file="022_query_optimization.sql")
