...
const badgeVariants = cva(
  'inline-flex items-center gap-1.5 rounded-lg border px-3 py-1.5 text-xs font-medium transition-all cursor-pointer',
  {
    variants: {
      variant: {
        default: 'border-cyan-500/30 bg-cyan-500/10 text-cyan-400 hover:bg-cyan-500/20',
        secondary: 'border-blue-500/30 bg-blue-500/10 text-blue-400 hover:bg-blue-500/20',
