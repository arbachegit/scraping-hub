...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-cyan-500/15 border-2 border-cyan-500 text-cyan-500 hover:bg-cyan-500 hover:text-white',
        secondary:
          'bg-secondary/15 border-2 border-secondary text-secondary hover:bg-secondary hover:text-white',
        destructive:
          'bg-destructive/15 border-2 border-destructive text-destructive hover:bg-destructive hover:text-white',
        outline:
